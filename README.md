...
Cartoview template project. Generates a django project with Cartoview & GeoNode support.

Currently, supporting [3.3.x](https://github.com/cartologic/cartoview-project/tree/3.3.x) branch.
...
1. Prepare the Environment
    ...
    ```bash
    git clone https://github.com/GeoNode/cartoview-project.git -b <your_branch>
